// src/features/user-auth/auth-screens/RegisterScreen.js
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <View style={styles.inner}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Rejoignez Khedma.ma</Text>
        </View>
        <View style={styles.form}>
          <Text style={styles.label}>Nom</Text>
          <TextInput style={styles.input} placeholder="ex: Client Test" value={name} onChangeText={setName} />
